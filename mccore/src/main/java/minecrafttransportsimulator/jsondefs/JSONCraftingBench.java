...
public class JSONCraftingBench {
    ...
    @JSONDescription("A list of item types this component can craft.  This is the first layer of filtering, and restricts the items displayed to only crafting items that have the same trackingType.  Valid types correspond to JSON definition types, those being the types that you make sub-folders for in your pack.")
