...
public class JSONParticle {
    ...
    @JSONDescription("Checks every frame for this particle to spawn.  Particles normally check every tick, though some require frame checks if their timings are small (like engine_pistion).")
