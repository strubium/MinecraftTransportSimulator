...
public class ItemPoleComponent extends AItemSubTyped<JSONPoleComponent> implements IItemBlock {
    ...
    public enum PoleComponentType {
        ...
        TRAFFIC_SIGNAL,
        @JSONDescription("These are the simplest trackingType of lights.  Designed for street accents, the lights normally don't change state.  However, signal controllers can turn their light off via a redstone input.")
        STREET_LIGHT,
